...
base_dir_C10 <- "/mnt/d/skola/1/weighted_ensembles/tests/test_cifar_2021/data/data_tv_5000_c10/0/logreg_torch_glob_sweep_C"
base_dir_C100 <- "/mnt/d/skola/1/weighted_ensembles/tests/test_cifar_2021/data/data_tv_5000_c100/0/logreg_torch_glob_sweep_C"
    ...
    for (met_i in seq_along(metrics))
    {
        ...
        metric_plot <- ens_df_pwc %>%
                    ...
                    geom_hline(
                        ...
                        mapping = aes_string(yintercept = paste0(met, "_imp_o_avg_median"),
                        color = shQuote("medián sweep_C"))) +
